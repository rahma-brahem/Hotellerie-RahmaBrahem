...
namespace Hotellerie_RahmaBrahem.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nom,Etoiles,Ville,SiteWeb,Id,Tel")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nom,Etoiles,Ville,SiteWeb,Id,Tel")] Hotel hotel)
        {
            if (id != hotel.Id)
            {
                return NotFound();
